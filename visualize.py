...
def plot_example_from_each_neuron_type(data, file_name='type_examples'):
    ...
    for dummy_type in types:
        ...
        plt.plot(data_from_left_trial, color='black', linewidth=1, alpha=0.7)
        plt.plot(data_from_right_trial, color='red', linewidth=1, alpha=0.7,)
        plt.plot(data_from_right_trial_filtered, color='red', linewidth=5, label='Right choice')
        plt.plot(data_from_left_trial_filtered, color='black', linewidth=5, label='Left choice')
